    ...
    try {
      ...
      if (driverData.van) {
        ...
        return {
          ...
          drivingAuthorization: driverData.van.drivingAuthorization || null
        };
      }
    } catch (error) {
    ...
    try {
      ...
      if (van) {
        ...
        return {
          ...
          drivingAuthorization: van.drivingAuthorization || null
        };
      } else {
        ...
        if (vans.length > 0) {
          ...
          return {
            ...
            drivingAuthorization: firstVan.drivingAuthorization || null
          };
        }
      }
    } catch (error) {
