    ...
    Tables: {
      ...
      route_history: {
        Row: {
          ...
          status: string
          students_delivered: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "route_history_driver_id_fkey"
            columns: ["driver_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "route_history_trip_id_fkey"
            columns: ["trip_id"]
            isOneToOne: false
            referencedRelation: "trips"
            referencedColumns: ["id"]
      ...
      route_tracking: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "route_tracking_trip_id_fkey"
            columns: ["trip_id"]
            isOneToOne: false
            referencedRelation: "trips"
            referencedColumns: ["id"]
      ...
      trips: {
        Row: {
          ...
          start_time: string | null
          status: string | null
          students_picked_up: number | null
          total_students: number | null
          updated_at: string | null
        }
        Insert: {
      ...
      vans: {
        Row: {
          ...
          created_at: string | null
          driver_id: string
          driving_authorization_url: string | null
          id: string
          is_active: boolean | null
          model: string
          observations: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "vans_driver_id_fkey"
            columns: ["driver_id"]
            isOneToOne: false
            referencedRelation: "drivers"
            referencedColumns: ["id"]
